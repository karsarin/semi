...
/**
 * Servlet implementation class CategoryRefusalServlet
 */
@WebServlet("/crefusal")
public class CategoryRefusalServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CategoryRefusalServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int result = new CategoryService().deleteBoard(Integer.parseInt(request.getParameter("cno")));
