...
/**
 * Servlet implementation class ClassificationMarketing
 */
@WebServlet("/cfmarketing")
public class ClassificationMarketing extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ClassificationMarketing() {
     }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(clist != null)
		{
			...
			view = request.getRequestDispatcher("views/classfication_category/categoryListViewMarketing.jsp");
