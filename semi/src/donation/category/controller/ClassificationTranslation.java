...
/**
 * Servlet implementation class ClassificationTranslation
 */
@WebServlet("/cftranslation")
public class ClassificationTranslation extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ClassificationTranslation() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<Category> clist = cservice.cfselectList(ccurrentPage, climit,str);
		...
		if(clist != null)
		{
			...
			view = request.getRequestDispatcher("views/classfication_category/categoryListViewTranslation.jsp");
