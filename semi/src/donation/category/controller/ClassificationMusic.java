...
/**
 * Servlet implementation class ClassificationMusic
 */
@WebServlet("/cfmusic")
public class ClassificationMusic extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ClassificationMusic() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(clist != null)
		{
			...
			view = request.getRequestDispatcher("views/classfication_category/categoryListViewMusic.jsp");
