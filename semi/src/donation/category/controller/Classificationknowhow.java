...
/**
 * Servlet implementation class Classificationknowhow
 */
@WebServlet("/cfknowhow")
public class Classificationknowhow extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Classificationknowhow() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(clist != null)
		{
			...
			view = request.getRequestDispatcher("views/classfication_category/categoryListViewKnowhow.jsp");
