...
/**
 * Servlet implementation class ClassificationDesign
 */
@WebServlet("/cfdesign")
public class ClassificationDesign extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ClassificationDesign() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(clist != null)
		{
			...
			view = request.getRequestDispatcher("views/classfication_category/categoryListViewDesign.jsp");
