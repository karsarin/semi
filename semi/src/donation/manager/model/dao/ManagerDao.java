...
public class ManagerDao {
	...
	public ArrayList<Category> selectCategoryList(Connection conn, int ccurrentPage, int climit) {
		...
		String query = "select * from("
					 ...
					 + "special, approval from category_board where approval=?)"
					 + "where rnum>=? and rnum<=?";
			...
			if(rset!=null) {
				...
				while(rset.next()) {
					Question question = new Question(
						...
						rset.getString("QUESTION_CONTENT"), rset.getString("question_original_imagename"),
						rset.getString("question_rename_imagename"), rset.getDate("QUESTION_DATE"), rset.getInt("QUESTION_READCOUNT"),
