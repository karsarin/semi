...
CONSTRAINT FK_SUGGESTWR FOREIGN KEY (SUGGEST_WRITER) REFERENCES MEMBER (MEMBER_ID) ON DELETE CASCADE,
CONSTRAINT FK_SUGGESTRE FOREIGN KEY (SUGGEST_RECIVE) REFERENCES MEMBER (MEMBER_ID) ON DELETE CASCADE
);
...
ALTER TABLE CATEGORY_BOARD ADD CONSTRAINT FK_CATEGORYGROUP FOREIGN KEY (CATEGORY_GROUP) REFERENCES CATEGORY_GROUP(GROUP_NO) ON DELETE CASCADE;
ALTER TABLE CATEGORY_BOARD ADD CONSTRAINT FK_USERID FOREIGN KEY (USER_ID) REFERENCES MEMBER(member_id) ON DELETE CASCADE;
...
REFERENCES CATEGORY_BOARD(CATEGORY_NO) ON DELETE CASCADE;
...
CREATE TABLE NOTICE(
  ...
  CONSTRAINT FK_NOTICEWR FOREIGN KEY(NOTICE_WRITER) REFERENCES MEMBER(MEMBER_ID) ON DELETE CASCADE 
);
...
COMMENT ON COLUMN question.question_original_imagename IS '원래이미지파일명';
COMMENT ON COLUMN question.question_rename_imagename IS '바뀐이미지파일명';
...
CREATE TABLE FREEBOARD(
  ...
  CONSTRAINT FK_FREEBOARDWR FOREIGN KEY(FREEBOARD_WRITER) REFERENCES MEMBER(MEMBER_ID) ON DELETE CASCADE
);
