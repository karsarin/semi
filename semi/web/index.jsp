...
<head>
	...
	<!-- Chart code -->
	<script>
		var chart = AmCharts.makeChart("chartdiv", {"type": "serial", "addClassNames": true, "theme": "light",  "autoMargins": false, 
													"marginLeft": 30, "marginRight": 8, "marginTop": 10, "marginBottom": 26, 
													"balloon": {"adjustBorderColor": false, "horizontalPadding": 10, "verticalPadding": 8, "color": "#ffffff"}, 
    												"dataProvider": [{"year": 2012, "income": 2.35, "expenses": 2.11 }, 
    																 {"year": 2013, "income": 2.62, "expenses": 2.55 }, 
    																 {"year": 2014, "income": 3.01, "expenses": 3.29 }, 
    																 {"year": 2015, "income": 2.95, "expenses": 3.41 },
    																 {"year": 2016, "income": 3.06, "expenses": 2.82, "dashLengthLine": 5 },
    																 {"year": 2017, "income": 3.41, "expenses": 3.29, "dashLengthColumn": 5, "alpha": 0.2, "additional": "(projection)"}],

    												"valueAxes": [{"axisAlpha": 0, "position": "left"}],
    												"startDuration": 1,
    												"graphs": [{"alphaField": "alpha",
    															"balloonText": "<span style='font-size:12px;'>[[title]] in [[category]]:<br><span style='font-size:20px;'>[[value]]</span> [[additional]]</span>",
    															"fillAlphas": 1, "title": "Donate", "type": "column", "valueField": "income", "dashLengthField": "dashLengthColumn"},
    														   {"id": "graph2",
    															"balloonText": "<span style='font-size:12px;'>[[title]] in [[category]]:<br><span style='font-size:20px;'>[[value]]</span> [[additional]]</span>",
    															"bullet": "round", "lineThickness": 3, "bulletSize": 7, "bulletBorderAlpha": 1,
    															"bulletColor": "#FFFFFF", "useLineColorForBulletBorder": true, "bulletBorderThickness": 3,
    															"fillAlphas": 0, "lineAlpha": 1, "title": "Prediction", "valueField": "expenses", "dashLengthField": "dashLengthLine"}],
	...
	<script>
		var chart = AmCharts.makeChart(
			"chartdiv2", {"type": "pie", "theme": "light", "dataProvider": [{"country": "IT", "litres": 501.9 }, 
			{"country": "디자인", "litres": 301.9}, {"country": "마케팅", "litres": 201.1}, {"country": "음악", "litres": 165.8}, 
			{"country": "노하우", "litres": 139.9}, {"country": "건강", "litres": 128.3}, {"country": "번역", "litres": 60}, {"country": "기타","litres": 50} ],
  			"valueField": "litres", "titleField": "country", "balloon":{"fixedPosition":true}, "export": {"enabled": true}
		});
	</script>	
<!--  그래프 끝 -->
</head>
<body>
	...
	<script type="text/javascript">
		function chat() {
			<%if(member!=null) { %>
			$.ajax({url:"/semi/newChat",
					data:{reciver:"<%=member.getMemberId()%>"},
					type:"post",
					success:function(data){
						if(data=="메세지존재") {
							window.open('/semi/chatcon?sender=<%=member.getMemberId()%>','','width=380,left=50,top=50, height=400');
						}
					},
					error:function(data){
	...
	<div class="site-slider">
		<div class="slider">
			<div class="flexslider">
				<ul class="slides">
					<li>
						<div class="overlay"></div> <img src="images/slide1.jpg" alt="">
					...
					<li>
						<div class="overlay"></div> <img src="images/slide2.jpg" alt="">
						<div class="slider-caption visible-md visible-lg">
					...
					<li>
						<div class="overlay"></div> <img src="images/slide3.jpg" alt="">
						<div class="slider-caption visible-md visible-lg">
