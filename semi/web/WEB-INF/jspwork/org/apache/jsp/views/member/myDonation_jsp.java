 ...
 * Generated at: 2017-11-01 07:50:11 UTC
...
public final class myDonation_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("donation.donate.model.vo.Donate");
...
return;
 ...
 Donate donate = (Donate)request.getAttribute("donate"); 
    ...
    String afterDate = (String)request.getAttribute("afterDate");
      ...
      out.write("}\r\n");
      out.write("/* Removes the clear button from date inputs */\r\n");
      out.write("#date::-webkit-clear-button {\r\n");
      out.write("    display: none;\r\n");
      out.write("}\r\n");
      out.write("\r\n");
      out.write("/* Removes the spin button */\r\n");
      out.write("#date::-webkit-inner-spin-button { \r\n");
      out.write("    display: none;\r\n");
      out.write("}\r\n");
      out.write("#dateclick{\r\n");
...
if(((double)ranking/memberTotal*100)<1){ 
      out.write("\r\n");
      out.write("<image src=\"/semi/images/rank/challenger.jpg\" align=\"center\" width=\"250px\" height=\"150px\"></image>\r\n");
 }else if(((double)ranking/memberTotal*100)<4){ 
      out.write("\r\n");
      out.write("<image src=\"/semi/images/rank/master.jpg\" align=\"center\" width=\"250px\" height=150px\"></image>\r\n");
 }else if(((double)ranking/memberTotal*100)<11){ 
      out.write("\r\n");
      out.write("<image src=\"/semi/images/rank/Diamond.jpg\" align=\"center\" width=\"250px\" height=\"150px\"></image>\r\n");
 }else if(((double)ranking/memberTotal*100)<24){ 
      out.write("\r\n");
      out.write("<image src=\"/semi/images/rank/Platinum.jpg\" align=\"center\" width=\"250px\" height=\"150px\"></image>\r\n");
 }else if(((double)ranking/memberTotal*100)<48){ 
      out.write("\r\n");
      out.write("<image src=\"/semi/images/rank/gold.jpg\" align=\"center\" width=\"250px\" height=\"150px\"></image>\r\n");
 }else if(((double)ranking/memberTotal*100)<70){ 
      out.write("\r\n");
      out.write("<image src=\"/semi/images/rank/silver.jpg\" align=\"center\" width=\"250px\" height=\"150px\"></image>\r\n");
 }else{ 
      out.write("\r\n");
      out.write("<image src=\"/semi/images/rank/bronze.png\" align=\"center\" width=\"250px\" height=\"150px\"></image>\r\n");
 } 
      out.write('\r');
      out.write('\n');
      out.print(member.getMemberNik() );
      ...
      out.write("\r\n");
      out.write("상위");
      out.print( (int)((double)ranking/memberTotal*100) );
      out.write("%<br>\r\n");
      out.write(" 총 기부금액  총 ");
      out.print( myDonation );
      out.write("원\r\n");
      out.write("</div>\r\n");
      out.write("\r\n");
      out.write("<br><br><br>\r\n");
      out.write("<form action=\"/semi/dselect?memberid=");
      out.print( member.getMemberId() );
      out.write("\"method=\"post\">\r\n");
      out.write("\t<div style=\"margin-left:0%;\">\r\n");
      out.write("\t\t<a style=\"font-size:8pt;\">총 ");
      out.print( listCount );
      out.write("개의 글을 찾았습니다.<a>\r\n");
      out.write("\t\t<a style=\"margin-left:41%;\">\r\n");
      out.write("\t\t<input type=\"date\" name =\"beforedate\" value=\"");
      out.print( beforeDate );
      out.write("\" id=\"date\"required=\"required\">~<input type=\"date\" name=\"afterdate\" value=\"");
      out.print( afterDate );
      out.write("\" id=\"date\"required=\"required\">\r\n");
      out.write("\t\t<input type=\"submit\"value=\"검색\" id=\"dateclick\">\r\n");
      out.write("\t\t</a>\r\n");
      out.write("\t</div>\r\n");
      out.write("</form>\r\n");
      out.write("<table align=\"center\"class=\"table table-hover\" id=\"table\">\r\n");
      out.write("<tr><th width = \"50pt\">No</th><th width = \"100pt\">기부자</th><th width = \"200pt\">기부금</th><th width=\"100pt\">날짜</th>\r\n");
 if(listCount != 0){ 
      out.write('\r');
      out.write('\n');
      out.write('	');
 for(Donate d : list){ 
      ...
      out.print( d.getDonationNo() );
      out.write("</td>\r\n");
      out.write("\t<td>");
      out.print( d.getMemberId() );
      out.write("</td>\r\n");
      out.write("\t<td>");
      out.print( d.getDonation() );
      out.write("</td>\t\r\n");
      out.write("\t<td>");
      ...
      out.write("\r\n");
      out.write("\t<tr>\r\n");
      out.write("\t\t<td colspan=\"4\" align=\"center\" style=\"font-size:10pt; color:gray;\">기부내역이 없습니다</td>\r\n");
      out.write("\t</tr>\r\n");
 } 
      out.write("\r\n");
      out.write("</table>\r\n");
 ...
 if(currentPage <=1){ 
      ...
      out.write("\r\n");
      out.write("\t<a href=\"/semi/dselect?page=");
      out.print( currentPage -1);
      out.write("&memberid=");
      out.print( member.getMemberId() );
      out.write("&beforedate=");
      out.print( beforeDate );
      out.write("&afterdate=");
      out.print( afterDate );
      out.write("\">[이전]</a>\r\n");
 ...
 if(currentPage >= maxPage){ 
      ...
      out.write("\t<div align=\"center\" style=\"font-size:20pt;color:crimson;\">");
      out.print( member.getMemberNik() );
      out.write("님의 기부기록이 없습니다.</div>\r\n");
      out.write("\t");
 } 
      out.write(" \r\n");
      out.write("\r\n");
