 ...
 * Generated at: 2017-10-31 04:06:42 UTC
...
public final class categoryDetailView_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/views/category/../../headerbar.jsp", Long.valueOf(1509413753976L));
    _jspx_dependants.put("/views/category/../../header.jsp", Long.valueOf(1509413753976L));
    _jspx_dependants.put("/views/category/../../rightList.jsp", Long.valueOf(1509417596504L));
    _jspx_dependants.put("/views/category/../../../views/manager/managerHeader.jsp", Long.valueOf(1509413753179L));
  }
...
return;
	...
	int currentPage = ((Integer)request.getAttribute("ccurrentPage")).intValue();
      ...
      out.write("\t\tlocation.href=\"/semi/views/category/categoryPurchaseView.jsp\";\r\n");
      out.write("\t}\r\n");
      out.write("</script>\r\n");
      out.write("\r\n");
      out.write("</head>\r\n");
...
if(member!=null&&member.getMemberId().equals("admin")) { 
 ...
 if(member != null && member.getConnection().equals("Y")){ 
      ...
      out.write("  </td>\r\n");
      out.write("  </tr>\r\n");
      out.write("  <tr><th width=\"160px\">연락처</th><td>");
      out.print( category.getPhone() );
      out.write("</td></tr>\r\n");
      out.write("  <tr><th width=\"160px\">이메일</th><td>");
      out.print( category.getEmail() );
      out.write("</td></tr>\r\n");
      out.write(" <tr><td colspan=\"2\" align=\"center\"> <button type=\"button\" class=\"btn btn-primary btn-lg\" onclick=\"javascript:goPurchaseView();\">재능 구매하기</button></tr>\r\n");
      out.write(" <tr><td align=\"center\"><button type=\"button\" class=\"btn btn-success\" onclick=\"location.href='/semi/swrite?reciver=");
      out.print(category.getUserId());
      out.write("&sender=");
      out.print(member.getMemberId());
      out.write("'\">문의 보내기</button></td>\r\n");
      out.write(" \t\t<td align=\"center\">");
      out.write("\r\n");
      out.write(" \t\t\t\t <a href=\"#\" class=\"btn btn-success\" onclick=\"return chat();\">채팅가능</a>\r\n");
      out.write(" \t\t\t\t <script type=\"text/javascript\">\r\n");
...
if(member!=null && member.getMemberId().equals("admin") && category.getApproval().equals("N")){
 ...
 if(member.getMemberId().equals(category.getCategoryWriter())){
      ...
      out.write(" \t<button type=\"button\" class=\"btn btn-danger\" onclick=\"cdelete\">재능 삭제</button>\r\n");
      out.write(" \t</td></tr>\r\n");
      out.write(" \t");
} 
      out.write("\r\n");
      ...
      out.write("\r\n");
      out.write("<!-- 게시글 정보 -->\r\n");
      out.write("\t<div align=\"left\" style=\"margin-top:180px;\">\r\n");
      ...
      out.write(" \t \t<tr><th>요구 기부금</th><th>구매평점</th><th>작업기간</th><th>작업현황</th><th>조회수</th></tr>\r\n");
      out.write(" \t \t<tr><td>");
      out.print( category.getCategoryDonation() );
      out.write("</td><td>");
      out.print( category.getVerdict() );
      out.write("</td><td>");
      ...
      out.print( category.getCategoryDonation() );
      out.write("원 이상 구매 가능</font> &nbsp; <button type=\"button\" class=\"btn btn-primary btn-lg\" onclick=\"javascript:goPurchaseView();\">재능 구매하기</button><br>\r\n");
      out.write("\t<hr>\r\n");
      out.write("\t</div>\r\n");
      out.write("\t\r\n");
