 ...
 * Generated at: 2017-10-31 11:19:25 UTC
...
public final class myWriteListView_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("donation.member.model.vo.MyWrite");
...
if(member!=null&&member.getMemberId().equals("admin")) { 
 ...
 if(member!=null){ 
      ...
      out.write("\t\tlocation.href = \"/semi/mylist?value=\"+value+\"&memberid=");
      out.print( member.getMemberId() );
      out.write("\";\r\n");
      out.write("\t}\r\n");
      out.write("\r\n");
      ...
      out.write("<div align=\"center\">내가 쓴 글  총 ");
      out.print(listCount );
      out.write("개 조회\r\n");
      out.write("\t\r\n");
      out.write("\t<select  name=\"select\" onchange=\"select(this.options[this.selectedIndex].value)\"id=\"select\">\r\n");
 ...
 if(boardNo ==3){ 
      ...
      out.write("<tr><th width = \"50pt\">No</th><th width=\"150pt\">구 분</th><th width=\"70pt\">글 번호</th><th width=\"400pt\"><div align=\"center\">제 목</div></th><th>조회수</th><th width = \"100pt\">작성자</th><th width=\"150pt\">작성일</th>\r\n");
 if(listCount != 0){ 
      out.write('\r');
      out.write('\n');
      out.write('	');
 for(MyWrite d : list){ 
      ...
      out.print( d.getListNo() );
      out.write("</td>\r\n");
      out.write("\t<td>");
      out.print( d.getBoardName() );
      out.write("</td>\r\n");
      out.write("\t<td>");
      out.print( d.getBoardNo() );
      out.write("</td>\r\n");
      out.write("\t");
 if(d.getBoardName().equals("재능기부")){ 
      out.write("\r\n");
      out.write("\t<td><a href=\"/semi/cdetail?cnum=");
      out.print(d.getBoardNo() );
      out.write("&cpage=");
      ...
      out.write("\r\n");
      out.write("\t<td><a href=\"/semi/fdetail?no=");
      out.print(d.getBoardNo());
      out.write('"');
      out.write('>');
      out.print( d.getTitle() );
      ...
      out.write("\r\n");
      out.write("\t<tr>\r\n");
      out.write("\t\t<td colspan=\"4\" align=\"center\" style=\"font-size:10pt; color:gray;\">게시글이 없습니다</td>\r\n");
      out.write("\t</tr>\r\n");
 } 
      out.write("\r\n");
      out.write("</table>\r\n");
 ...
 if(currentPage <=1){ 
      ...
      out.write("\r\n");
      out.write("\t<a href=\"/semi/mylist?page=");
