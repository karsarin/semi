...
<!-- 그림 적용 -->
<link rel='stylesheet' href='/semi/image_js/style.css' media='screen' />
<script
			...
			<div>
				<hgroup>
					<div class="row" style="width: 1000px">
						<div class="col-md-4">
							<h1 style="font-size: 20pt">카테고리 노하우/상담 게시판</h1>
					...
					<div class="row" style="float: left; width: 300px; height: 400px;">
						<div class="col-md-4" style="width: 300px;">
							...
							<p>
								...
								<%=c.getUserId()%>
								<br>
								<%=c.getCategoryDonation()%>원 <br>★★★★ 후기 5건
							</p>
						</div>
