...
<head>	
    ...
    <script type="text/javascript">
    	...
    	function suggest() {
    		location.href = "/semi/swrite?reciver="+$("input[name='memberId']").val()+"&sender="+"admin";	
    		return false;
    	}
	</script>
</head>
		...
		<div class="col-md-4 col-sm-12">
			...
			<form class="memberDetail" action="/semi/mgrmupdate">
				...
				<div class="form-group" align="center">
						<button type="button" onclick="return suggest();" class="btn btn-success" style="margin-right:10px;">쪽지보내기</button>
